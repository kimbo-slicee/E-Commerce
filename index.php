...
if(!empty($userName)&&!empty($pwd)){
  //... Contecte to the DataBase 
  require_once'./Database.php';
  $date=date('y-m-d');
  $sqlState=$pdo->prepare('INSERT INTO utilisateur VALUES(null,?,?,?)');
  $sqlState->execute(array($userName,$pwd,$date));
...
<input type="submit" style="background-color:#04AA6D ;" name="Add" value="AddUsre" class="btn btn-primary btn-lg my-2">
</form>
</div>
</body>
</html>